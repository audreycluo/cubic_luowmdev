...
# load age effects
gam_age_md = pd.read_csv("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/GAM/dti_md/GAMresults.dti_md.age_plotbundles.csv")
...
# Save the scene
output_path = ospj("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/both_datasets/", f'{subject}_all_bundles_age_effect_HCPD.png')
