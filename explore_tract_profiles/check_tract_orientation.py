...
def view_bundles(L_t1w, R_t1w, sft_L, sft_R, L_profile, R_profile):
    ...
    #sft_L.to_vox() # i dont know if i actually need this line
...
def run_view_bundles(tract_name, scalar):
    ...
    if tract_name == "FA" or tract_name == "FP":
        ...
        sft = load_trk(ospj(bundle_path,
                            f'{subject}_ses-V1_space-T1w_desc-preproc_dwi_space-RASMM_model-probCSD_algo-AFQ_desc-{tract_name}_tractography.trk'), scalar_img)
        print("trk's loaded")
        ...
        tract_profiles  = pd.read_csv(ospj(afq_path, f'{subject}_ses-V1_space-T1w_desc-preproc_dwi_space-RASMM_model-probCSD_algo-AFQ_desc-profiles_dwi.csv'))
        ...
        sft_L = load_trk(ospj(bundle_path,
                            f'{subject}_ses-V1_space-T1w_desc-preproc_dwi_space-RASMM_model-probCSD_algo-AFQ_desc-{tract_name}L_tractography.trk'), scalar_img)
        sft_R = load_trk(ospj(bundle_path,
                            f'{subject}_ses-V1_space-T1w_desc-preproc_dwi_space-RASMM_model-probCSD_algo-AFQ_desc-{tract_name}R_tractography.trk'), scalar_img)
        print("trk's loaded")
