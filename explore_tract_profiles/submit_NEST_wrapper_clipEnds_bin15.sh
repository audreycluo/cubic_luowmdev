...
r_script="/cbica/projects/luo_wm_dev/code/tract_profiles/explore_tract_profiles/NEST_wrapper_clipEnds_bin15.R"
...
for dataset in "${datasets[@]}"; do
    ...
    sbatch --job-name=NEST_${dataset} \
           ...
           singularity_NEST_bin15.sh ${dataset} ${tract_list} 
done
