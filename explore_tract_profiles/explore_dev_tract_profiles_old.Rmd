...
load_and_save_data <- function(dataset, scalars) {
  ...
  for (scalar in scalars) {
     if (dataset == "PNC" && (scalar == "dki_md" || scalar == "dki_fa")) {
      ...
      assign(paste0(dataset, "_GAM_smooth_fittedvalues", scalar), smoothfitted_data, envir = .GlobalEnv)
...
arrange_tract_plots <- function(list_figures, title, legend.width = NULL, legend.label = NULL) {
  ...
  AP_frontotemp_plots <- ggarrange(list_figures$`Arcuate`, ncol=2, nrow = 1) #list_figures$`Uncinate`
...
arrange_callosum_plots <- function(list_figures, title) {
  callosum_plots <- ggarrange(list_figures$`Callosum Anterior Frontal`, 
                           ...
                           list_figures$`Callosum Temporal`, common.legend=TRUE, legend = c("bottom"), ncol=4, nrow = 2)
...
cc_motor_plots <- plot_age_effect_clipEnds("Callosum Motor", "dti_md", ageeffect_measure, clipEnds = 5, "Callosum Motor", callosum=TRUE)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/luo_wm_dev/Preliminary_Figures/cc_motor_plot.png", final_layout, width = 5, height = 5)
...
```{r arrange all nodes HCPD, fig.height = 10, fig.width = 20}
arrange_tract_plots(all_smooths_HCPD, "HCPD")
arrange_callosum_plots(all_smooths_HCPD, "HCPD")

```
```{r arrange all nodes HBN, fig.height = 10, fig.width = 20}
arrange_tract_plots(all_smooths_HBN, "HBN")
arrange_callosum_plots(all_smooths_HBN, "HBN")
``` 

```{r arrange all nodes PNC, fig.height = 10, fig.width = 20}
arrange_tract_plots(all_smooths_PNC, "PNC")
arrange_callosum_plots(all_smooths_PNC, "PNC")
...
arrange_callosum_AP_plots <- function(list_figures, title) {
  callosum_plots <- ggarrange(list_figures$`Callosum Orbital`, 
                              ...
                              list_figures$`Callosum Occipital`, common.legend=TRUE, legend = c("bottom"), ncol=4, nrow = 2)
  tractprofiles_plot_final <- annotate_figure(callosum_plots, top = text_grob(title, 
               color = "black", face = "italic", size = 28))
   return(tractprofiles_plot_final)
}
...
```{r arrange binned smooths HCPD, fig.height = 10, fig.width = 25}
x.grob <- textGrob("Age", 
...
binned_smooths_HCPD_callosum <- arrange_callosum_plots(binned_smooths_HCPD, "HCPD: Developmental Trajectories of Tract Regions")
binned_smooths_HCPD_callosum_AP <- arrange_callosum_AP_plots(binned_smooths_HCPD, "HCPD: Developmental Trajectories of Tract Regions")


grid.arrange(arrangeGrob(binned_smooths_HCPD_main, left = y.grob, bottom = x.grob))
grid.arrange(arrangeGrob(binned_smooths_HCPD_callosum, left = y.grob, bottom = x.grob))
grid.arrange(arrangeGrob(binned_smooths_HCPD_callosum_AP, left = y.grob, bottom = x.grob))


```


```{r arrange binned smooths HBN, fig.height = 10, fig.width = 25}
x.grob <- textGrob("Age", 
                   gp=gpar(col="black", fontsize=24))
y.grob <- textGrob("Zero-Centered DTI MD", 
                   gp=gpar(col="black", fontsize=24), rot=90)
...
binned_smooths_HBN_callosum <- arrange_callosum_plots(binned_smooths_HBN, "HBN: Developmental Trajectories of Tract Regions")
binned_smooths_HBN_callosum_AP <- arrange_callosum_AP_plots(binned_smooths_HBN, "HBN: Developmental Trajectories of Tract Regions")


grid.arrange(arrangeGrob(binned_smooths_HBN_main, left = y.grob, bottom = x.grob))
grid.arrange(arrangeGrob(binned_smooths_HBN_callosum, left = y.grob, bottom = x.grob))
grid.arrange(arrangeGrob(binned_smooths_HBN_callosum_AP, left = y.grob, bottom = x.grob))

```


```{r arrange binned smooths PNC, fig.height = 10, fig.width = 25}
x.grob <- textGrob("Age", 
                   gp=gpar(col="black", fontsize=24))
y.grob <- textGrob("Zero-Centered DTI MD", 
                   gp=gpar(col="black", fontsize=24), rot=90)
...
binned_smooths_PNC_callosum <- arrange_callosum_plots(binned_smooths_PNC, "PNC: Developmental Trajectories of Tract Regions")
binned_smooths_PNC_callosum_AP <- arrange_callosum_AP_plots(binned_smooths_PNC, "PNC: Developmental Trajectories of Tract Regions")


grid.arrange(arrangeGrob(binned_smooths_PNC_main, left = y.grob, bottom = x.grob))
grid.arrange(arrangeGrob(binned_smooths_PNC_callosum, left = y.grob, bottom = x.grob))
grid.arrange(arrangeGrob(binned_smooths_PNC_callosum_AP, left = y.grob, bottom = x.grob))
...
HBN_GAM_smooth_fittedvalues_dti_md
```
