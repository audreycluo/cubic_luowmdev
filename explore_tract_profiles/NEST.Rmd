...
atr <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Anterior Thalamic_numNodes10_twsided.RData")
arc <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Arcuate_numNodes10_twsided.RData")
cing <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Cingulum Cingulate_numNodes10_twsided.RData")
cst <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Corticospinal_numNodes10_twsided.RData")
ifo <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Inferior Fronto-occipital_numNodes10_twsided.RData")
ilf <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Inferior Longitudinal_numNodes10_twsided.RData")
slf <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Superior Longitudinal_numNodes10_twsided.RData")
parc <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Posterior Arcuate_numNodes10_twsided.RData")
unc <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Uncinate_numNodes10_twsided.RData")

p.adjust(unlist(c(arc$pval, cing$pval, ifo$pval, ilf$pval, slf$pval, parc$pval, unc$pval)), method=c("fdr"))
...
```{r check outputs HBN}
atr <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Anterior Thalamic_numNodes10_twsided.RData")
arc <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Arcuate_numNodes10_twsided.RData")
cing <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Cingulum Cingulate_numNodes10_twsided.RData")
cst <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Corticospinal_numNodes10_twsided.RData")
...
```{r check outputs PNC}
atr <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Anterior Thalamic_numNodes10_twsided.RData")
arc <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Arcuate_numNodes10_twsided.RData")
cing <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Cingulum Cingulate_numNodes10_twsided.RData")
cst <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Corticospinal_numNodes10_twsided.RData")
ifo <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Inferior Fronto-occipital_numNodes10_twsided.RData")
ilf <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Inferior Longitudinal_numNodes10_twsided.RData")
parc <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Posterior Arcuate_numNodes10_twsided.RData")
