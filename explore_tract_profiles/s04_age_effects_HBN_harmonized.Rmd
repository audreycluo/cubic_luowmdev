...
all_subjects <- readRDS("/cbica/projects/luo_wm_dev/input/HBN/HBN_tractprofiles/all_subjects/collated_tract_profiles_md_covbat.RData")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/tract_profiles_fa_mean.png", grid.arrange(arrangeGrob(tractprofiles_fa_mean_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 15, height = 10, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/tract_profiles_dti_fa.png", grid.arrange(arrangeGrob(tractprofiles_fa_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 15, height = 10, units = "in")
```
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/tract_profiles_dti_md_mean.png", grid.arrange(arrangeGrob(tractprofiles_md_mean_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 15, height = 10, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/tract_profiles_dti_md_cv.png", grid.arrange(arrangeGrob(tractprofiles_md_cv_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 15, height = 10, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/tract_profiles_dti_md.png", grid.arrange(arrangeGrob(tractprofiles_md_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 15, height = 10, units = "in")
```
...
ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/tract_profiles_md_boxplot.png", boxplot, width = 5, height = 5, units = "in")
```
...
gam_age_fa <- read.csv("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_fa/GAMresults.dti_fa.age.csv")
gam_age_fa <- gam_age_fa %>% select(-X)

gam_age_md <- read.csv("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/GAMresults.dti_md.age.csv")
gam_age_md <- gam_age_md %>% select(-X)
 
# determine correct age effect sign for delta adjusted Rsq using equivalent linear model
# load linear models
lm_age_fa <- read.csv("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_fa/LinearModelresults.dti_fa.age.csv")
lm_age_md <- read.csv("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/LinearModelresults.dti_md.age.csv")
...
############################################################
percent_change_fa <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_fa/posterior_percentchange/HBN_posterior_percentchange.RData")
...
percent_change_md <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/posterior_percentchange/HBN_posterior_percentchange.RData")
...
#######################################################################
norm_percent_change_fa <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_fa/posterior_percentchange/HBN_posterior_percentchange_normalized.RData")
...
norm_percent_change_md <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/posterior_percentchange/HBN_posterior_percentchange_normalized.RData")
...
#write.csv(gam_age_md_bilat, "/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/GAM_bilateral_signedresults.dti_md.age.csv")

 

#write.csv(gam_age_fa, "/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_fa/GAMresults.dti_fa.age_reoriented.csv")
#write.csv(gam_age_md, "/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/GAMresults.dti_md.age_reoriented.csv")
 
#saveRDS(ci_pc_fa, "/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_fa/posterior_percentchange/HBN_posterior_percentchange_reoriented.RData")
#saveRDS(ci_pc_md, "/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/posterior_percentchange/HBN_posterior_percentchange_reoriented.RData")
 
#saveRDS(ci_norm_pc_fa, "/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_fa/posterior_percentchange/HBN_posterior_percentchange_normalized_reoriented.RData")
#saveRDS(ci_norm_pc_md, "/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/posterior_percentchange/HBN_posterior_percentchange_normalized_reoriented.RData")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/age_effect_rsq_fa.png", grid.arrange(arrangeGrob(age_rsq_fa_plots_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 10, units = "in")
```
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/age_effect_pc_fa.png", grid.arrange(arrangeGrob(age_pc_fa_plots_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 10, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/age_effect_norm_pc_fa.png", grid.arrange(arrangeGrob(age_norm_pc_plots_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 10, units = "in")
```
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/age_effect_rsq_md.png", grid.arrange(arrangeGrob(age_rsq_md_plots_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 10, units = "in")
```
...
In contrast to HCP-D, in HBN we're seeing that posterior regions of tracts like IFO and ILF seem to have greater age-related changes than anterior regions. Could be due to the fact that I didn't exclude Staten Island from HBN, or could have to do with psychopathology... It's on my list to exclude SI and re-calculate age effects for HBN. 
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/age_effect_pc_md.png", grid.arrange(arrangeGrob(age_pc_md_plots_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 10, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/age_effect_norm_pc_md.png", grid.arrange(arrangeGrob(age_norm_pc_plots_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 10, units = "in")
```
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/age_effect_lm_md.png", grid.arrange(arrangeGrob(age_lm_plots_final, left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 10, units = "in")
```
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/dist_to_cort_rsq_fa.png", grid.arrange(arrangeGrob(arrange_dist_to_cortex(rsq_fa_dist_plots, "FA Delta Adjusted Rsq"), left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 20, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/dist_to_cort_pc_fa.png", grid.arrange(arrangeGrob(arrange_dist_to_cortex(pc_fa_dist_plots, "FA Percent Change"), left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 20, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/dist_to_cort_norm_pc_fa.png", grid.arrange(arrangeGrob(arrange_dist_to_cortex(norm_pc_fa_dist_plots, "FA Normalized Percent Change"), left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 20, units = "in")

```

- We are seeing that anterior portions of CC, IFO, and ILF have smaller age effects than posterior portions. Could be due to the fact that I didn't exclude Staten Island from HBN, or could have to do with psychopathology... It's on my list to exclude SI and re-calculate age effects for HBN. 
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/dist_to_cort_rsq_md.png", grid.arrange(arrangeGrob(arrange_dist_to_cortex(rsq_md_dist_plots, "MD Delta Adjusted Rsq"), left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 20, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/dist_to_cort_pc_md.png", grid.arrange(arrangeGrob(arrange_dist_to_cortex(pc_md_dist_plots, "MD Percent Change"), left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 20, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/dist_to_cort_norm_pc_md.png", grid.arrange(arrangeGrob(arrange_dist_to_cortex(norm_pc_md_dist_plots, "MD Normalized Percent Change"), left = y.grob, bottom = x.grob, right = space.grob)), width = 16, height = 20, units = "in")
```
...
- Used nodewise GAMs and estimated zero-centered smooths using `smooth_estimates`
...
Seeing more dissociable trajectories for FA in HBN compared to HCP-D - kind of interesting. 
```{r plot fa nodewise dev traj zero centered all, fig.height=24, fig.width=22}
 
devtraj_zeroed_fa <- lapply(unique(nodewise_smoothfits_fa$tractID), plot_nodes_zeroed, df = nodewise_smoothfits_fa, scalar = "FA", -0.1, 0.1) 
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/devtraj_zeroed_fa.png", grid.arrange(arrangeGrob(devtraj_zeroed_fa_plots, left = y.grob, bottom = x.grob, right = space.grob)), width = 22, height = 24, units = "in")
```
...
##ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/fitted_val_tract_ends_centered_md.png",  ggarrange(AP_tract_ends_centered_md, AP_frontotemp_tract_ends_centered_md, SI_tract_ends_centered_md, CP_tract_ends_centered_md, nrow=2, ncol =2) + bgcolor("white"), width = 25, height = 10, units = "in")
```

We see dissociable trajectories along each tract: 
- For A-P tracts, lower node IDs (blue; anterior segments) have more steeply decreasing trajectories and higher node IDs (red; posterior segments) flatten out around mid-adolescence only in SLF. FOR ATR, CC, IFO, and ILF, lower node IDs (blue; anterior) seem to have shallower slopes. But deeper tract regions (yellow) still have distinct trajectories that appear flatter than either end of the tract. 
- For R-L tracts, we also see distinct trajectories in deep white matter (yellow) compared to peripheral (red/blue), but we see that deep white matter seems to increase in Forceps minor, which is maybe surprising? Issues of noise?
...
devtraj_zeroed_md <- lapply(unique(nodewise_smoothfits_md$tractID), plot_nodes_zeroed, df = nodewise_smoothfits_md, scalar = "MD", -0.00007, 0.00006) 
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/devtraj_zeroed_md.png", grid.arrange(arrangeGrob(devtraj_zeroed_md_plots, left = y.grob, bottom = x.grob, right = space.grob)), width = 22, height = 20, units = "in")
```
...
fitted_all_ages <- function(tract_name, te_model) {
  df <- gam_df %>% filter(tract_hemi == tract_name)
  # Predict trends for each node, ages 5-22
  pdat <- with(df,
                data.frame(age = rep(5:22, each = 100),
                           nodeID = rep(seq(from = 0, to = 99, by = 1), times = 18), # could maybe do a version of this where by=1
                           mean_fd = mean(te_model$model$mean_fd),
                           subjectID = "subID", 
                           sex = "M"))  
  newdf <- expand.grid(sex="M", age=c(5:22), mean_fd = mean(te_model$model$mean_fd))
...
gam_df <- merge(tract_profiles, cohortfile, by="subjectID")
gam_df <- gam_df %>% mutate(tract_node = paste0(tract_hemi, "_", nodeID))
gam_df$sex <- gsub("Female", "F", gam_df$sex)
gam_df$sex <- gsub("Male", "M", gam_df$sex)
gam_df$sex <- as.factor(gam_df$sex)
...
###ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/fitted_val_tract_ends_fa.png", 
...
```{r fit gams md for fitted values, cache = TRUE, include=FALSE, eval=FALSE}
...
saveRDS(fitted_md, "/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/dev_traj_fitted_md.RData")
```
 
```{r load fitted values, cache=TRUE}
fitted_md <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/GAM/dti_md/dev_traj_fitted_md.RData")
```
...
AP_tract_ends_md <- plot_tract_ends("AP", fitted_md, "MD", mycolors, 0.0003, 0.0008) 

nb.cols <- 5
mycolors <- colorRampPalette(paletteer::paletteer_d("LaCroixColoR::Pamplemousse"))(nb.cols)
AP_frontotemp_tract_ends_md <- plot_tract_ends("AP_frontal_temporal", fitted_md, "MD", mycolors, 0.00045, 0.0008) 

SI_tract_ends_md <- plot_tract_ends("SI", fitted_md, "MD", mycolors, 0.0003, 0.0008) 
nb.cols <- 10
mycolors <- colorRampPalette(paletteer::paletteer_d("LaCroixColoR::Pamplemousse"))(nb.cols)
 
CP_tract_ends_md <- plot_tract_ends("CP", fitted_md, "MD", mycolors, 0.0003, 0.0008) 

ggarrange(AP_tract_ends_md, AP_frontotemp_tract_ends_md, SI_tract_ends_md, CP_tract_ends_md, nrow=2, ncol =2)

#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/fitted_val_tract_ends_md.png", ggarrange(AP_tract_ends_md, AP_frontotemp_tract_ends_md, SI_tract_ends_md, CP_tract_ends_md, nrow=2, ncol =2) + bgcolor("white"), width = 20, height = 10, units = "in")
...
ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/fitted_val_tract_ends_md_arranged.png", grid.arrange(gA, gB, gC, gD), width = 11, height = 13, units = "in")
...
#ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/fitted_val_tract_ends_cp_md.png", central_peripheral_specific, width = 13, height = 20, units = "in")
...
##ggsave("/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/HBN/fitted_val_tract_ends_ap_md.png", anterior_posterior_specific, width = 10, height = 15, units = "in")
```
