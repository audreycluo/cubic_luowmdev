...
# HCPD
arc_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Arcuate_bin5_clip5_2sided.RData")
cst_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Corticospinal_bin5_clip5_2sided.RData")
ifo_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Inferior_Fronto_occipital_bin5_clip5_2sided.RData")
ilf_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Inferior_Longitudinal_bin5_clip5_2sided.RData")
slf_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Superior_Longitudinal_bin5_clip5_2sided.RData")
parc_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Posterior_Arcuate_bin5_clip5_2sided.RData")
vof_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Vertical_Occipital_bin5_clip5_2sided.RData")

cc_af_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Callosum_Anterior_Frontal_bin5_clip5_2sided.RData")
cc_mot_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Callosum_Motor_bin5_clip5_2sided.RData")
cc_occ_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Callosum_Occipital_bin5_clip5_2sided.RData")
cc_orb_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Callosum_Orbital_bin5_clip5_2sided.RData")
cc_pp_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Callosum_Posterior_Parietal_bin5_clip5_2sided.RData")
cc_sf_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Callosum_Superior_Frontal_bin5_clip5_2sided.RData")
cc_sp_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Callosum_Superior_Parietal_bin5_clip5_2sided.RData")
cc_tm_HCPD <- readRDS("/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/NEST/Callosum_Temporal_bin5_clip5_2sided.RData")
 
NEST_HCPD <- data.frame(cbind(tracts, p.adjust(unlist(c(cc_af_HCPD$pval, cc_mot_HCPD$pval, cc_occ_HCPD$pval, cc_orb_HCPD$pval, cc_pp_HCPD$pval, cc_sf_HCPD$pval, cc_sp_HCPD$pval, cc_tm_HCPD$pval, arc_HCPD$pval, cst_HCPD$pval, ifo_HCPD$pval, ilf_HCPD$pval, parc_HCPD$pval, slf_HCPD$pval, vof_HCPD$pval)), method=c("fdr")), rep("HCP-D", 15))) %>% setNames(c("tract_label", "pval_fdr_all", "Dataset"))

# HBN
arc_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Arcuate_bin5_clip5_2sided.RData")
cst_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Corticospinal_bin5_clip5_2sided.RData")
ifo_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Inferior_Fronto_occipital_bin5_clip5_2sided.RData")
ilf_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Inferior_Longitudinal_bin5_clip5_2sided.RData")
slf_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Superior_Longitudinal_bin5_clip5_2sided.RData")
parc_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Posterior_Arcuate_bin5_clip5_2sided.RData")
vof_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Vertical_Occipital_bin5_clip5_2sided.RData")

cc_af_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Callosum_Anterior_Frontal_bin5_clip5_2sided.RData")
cc_mot_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Callosum_Motor_bin5_clip5_2sided.RData")
cc_occ_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Callosum_Occipital_bin5_clip5_2sided.RData")
cc_orb_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Callosum_Orbital_bin5_clip5_2sided.RData")
cc_pp_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Callosum_Posterior_Parietal_bin5_clip5_2sided.RData")
cc_sf_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Callosum_Superior_Frontal_bin5_clip5_2sided.RData")
cc_sp_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Callosum_Superior_Parietal_bin5_clip5_2sided.RData")
cc_tm_HBN <- readRDS("/cbica/projects/luo_wm_dev/output/HBN/tract_profiles/NEST/Callosum_Temporal_bin5_clip5_2sided.RData")
 
NEST_HBN <- data.frame(cbind(tracts, p.adjust(unlist(c(cc_af_HBN$pval, cc_mot_HBN$pval, cc_occ_HBN$pval, cc_orb_HBN$pval, cc_pp_HBN$pval, cc_sf_HBN$pval, cc_sp_HBN$pval, cc_tm_HBN$pval, arc_HBN$pval, cst_HBN$pval, ifo_HBN$pval, ilf_HBN$pval, parc_HBN$pval, slf_HBN$pval, vof_HBN$pval)), method=c("fdr")), rep("HBN", 15))) %>% setNames(c("tract_label", "pval_fdr_all", "Dataset"))

# PNC
arc_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Arcuate_bin5_clip5_2sided.RData")
cst_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Corticospinal_bin5_clip5_2sided.RData")
ifo_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Inferior_Fronto_occipital_bin5_clip5_2sided.RData")
ilf_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Inferior_Longitudinal_bin5_clip5_2sided.RData")
slf_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Superior_Longitudinal_bin5_clip5_2sided.RData")
parc_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Posterior_Arcuate_bin5_clip5_2sided.RData")
vof_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Vertical_Occipital_bin5_clip5_2sided.RData")

cc_af_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Callosum_Anterior_Frontal_bin5_clip5_2sided.RData")
cc_mot_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Callosum_Motor_bin5_clip5_2sided.RData")
cc_occ_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Callosum_Occipital_bin5_clip5_2sided.RData")
cc_orb_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Callosum_Orbital_bin5_clip5_2sided.RData")
cc_pp_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Callosum_Posterior_Parietal_bin5_clip5_2sided.RData")
cc_sf_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Callosum_Superior_Frontal_bin5_clip5_2sided.RData")
cc_sp_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Callosum_Superior_Parietal_bin5_clip5_2sided.RData")
cc_tm_PNC <- readRDS("/cbica/projects/luo_wm_dev/output/PNC/tract_profiles/NEST/Callosum_Temporal_bin5_clip5_2sided.RData")
 
NEST_PNC <- data.frame(cbind(tracts, p.adjust(unlist(c(cc_af_PNC$pval, cc_mot_PNC$pval, cc_occ_PNC$pval, cc_orb_PNC$pval, cc_pp_PNC$pval, cc_sf_PNC$pval, cc_sp_PNC$pval, cc_tm_PNC$pval, arc_PNC$pval, cst_PNC$pval, ifo_PNC$pval, ilf_PNC$pval, parc_PNC$pval, slf_PNC$pval, vof_PNC$pval)), method=c("fdr")), rep("PNC", 15))) %>% setNames(c("tract_label", "pval_fdr_all", "Dataset"))
```
...
#range(bind_rows(callosum_norm_avgs)$mean_scalar)
...
#range(bind_rows(assoc_cst_avgs)$mean_scalar)
...
# plot lollipops
tracts <- unique(df_formatted$tract_label)
...
ggsave(paste0(png_dir, "fig2_lollipop.png"), arrange_callosum_plots(lollipop_plots), height = 13, width = 20, units = "in")
```
...
ggsave(paste0(png_dir, "fig3_lollipop.png"), arrange_association_plots(lollipop_plots), height = 13, width = 20, units = "in")
```
...
ggsave(paste0(png_dir, "fig4_PNC_brain.png"), CMot_brain_PNC, height = 3, width = 4, units = "in")
ggsave(paste0(png_dir, "fig4_HCPD_brain.png"), CMot_brain_HCPD, height = 3, width = 4, units = "in")
ggsave(paste0(png_dir, "fig4_HBN_brain.png"), CMot_brain_HBN, height = 3, width = 4, units = "in")
```
...
ggsave(paste0(png_dir, "fig4_NEST.png"), NEST_CMot, height = 3, width = 15, units = "in")
```
...
CMot_devtraj_final
ggsave(paste0(png_dir, "fig4_devtraj.png"), CMot_devtraj_final, height = 6, width = 15, units = "in")
``` 
...
ggsave(paste0(png_dir, "fig5_PNC_brain.png"), IFO_brain_PNC, height = 3, width = 4, units = "in")
ggsave(paste0(png_dir, "fig5_HCPD_brain.png"), IFO_brain_HCPD, height = 3, width = 4, units = "in")
ggsave(paste0(png_dir, "fig5_HBN_brain.png"), IFO_brain_HBN, height = 3, width = 4, units = "in")
...
ggsave(paste0(png_dir, "fig4and5_brain_legend.png"), brain_legend, height = 1, width = 5, units = "in")
```
...
y.grob <- textGrob(bquote(atop("Magnitude of Age Effect", 
                               "(" * Delta * " Adjusted " * R^2 * ")")), 
                   gp = gpar(col = "black", fontsize = 20), rot = 90)
ggsave(paste0(png_dir, "fig5_NEST.png"), NEST_IFO, height = 3, width = 15, units = "in")
```
...
IFO_devtraj_final
ggsave(paste0(png_dir, "fig5_devtraj.png"), IFO_devtraj_final, height = 6, width = 15, units = "in")
```
...
#perm.sphere.SAaxis_delta(glasser_SAaxis$SA.axis_rank, perm.id.full, "HCPD") # pspin =  0
#perm.sphere.SAaxis_delta(glasser_SAaxis$SA.axis_rank, perm.id.full, "HBN") # pspin =  NS
#perm.sphere.SAaxis_delta(glasser_SAaxis$SA.axis_rank, perm.id.full, "PNC") # pspin =  0.003
 
diffs_plot_PNC <- plot_diffs("PNC", p_label = expression(italic(p[spin]) == "0.003"), legend_position = "none")
diffs_plot_HCPD <- plot_diffs("HCPD", p_label = expression(italic(p[spin]) < "0.0001"), legend_position = "none")
diffs_plot_HBN <- plot_diffs("HBN", p_label = expression(italic(p[spin]) == "N.S."), legend_position = "none")
...
ggsave(paste0(png_dir, "fig6_delta_delta.png"), grid.arrange(arrangeGrob(diffs_plot_final, left = y.grob, bottom = x.grob)), height = 5, width = 12, units = "in")
...
map_CMot_final
ggsave(paste0(png_dir, "fig6_CMot_SArank.png"), map_CMot_final, height = 4, width = 10, units = "in")
...
ggsave(paste0(png_dir, "fig6_IFO_SArank.png"), map_IFO_final, height = 4, width = 10, units = "in")
ggsave(paste0(png_dir, "fig6_SA_legend.png"), plot_legend, height = 4, width = 10, units = "in")
```
...
aggregated_age_mat_plot <- plot_aggregated_maps(lh_all_datasets_ageMat, rh_all_datasets_ageMat, ylim1 = 15, ylim2 = 23, dataset = "Aggregated Age of Maturation Map Across Datasets")
aggregated_age_mat_plot
ggsave(paste0(png_dir, "fig7_aggregated_age_mat.png"), aggregated_age_mat_plot, height = 3, width = 8, units = "in")
```
...
#perm.sphere.p(x = aggregated_axis_PNC_binary$SA.axis_rank, y = aggregated_axis_PNC_binary$regional_mean_ageeffect, perm.id = perm.id.full, corr.type = "spearman") 
#perm.sphere.p(x = aggregated_axis_HCPD_binary$SA.axis_rank, y = aggregated_axis_HCPD_binary$regional_mean_ageeffect, perm.id = perm.id.full, corr.type = "spearman") 
#perm.sphere.p(x = aggregated_axis_HBN_binary$SA.axis_rank, y = aggregated_axis_HBN_binary$regional_mean_ageeffect, perm.id = perm.id.full, corr.type = "spearman") 

cor.test(aggregated_axis_PNC_binary$SA.axis_rank, aggregated_axis_PNC_binary$regional_mean_ageeffect, method = "spearman", use = "complete.obs") # r = 0.64, pspin < 0.0001

cor(aggregated_axis_HCPD_binary$SA.axis_rank, aggregated_axis_HCPD_binary$regional_mean_ageeffect, method = "spearman", use = "complete.obs") # r = 0.43, pspin = 0.00015

cor.test(aggregated_axis_HBN_binary$SA.axis_rank, aggregated_axis_HBN_binary$regional_mean_ageeffect, method = "spearman", use = "complete.obs") # r = 0.47, pspin = 0.0001
...
annot_text_PNC <- expression(paste(italic("r"), " = 0.64, ",  , italic(p[spin]), "< 0.0001"))
annot_text_HCPD <- expression(paste(italic("r"), " = 0.43, ",  , italic(p[spin]), "= 0.00015"))
annot_text_HBN <- expression(paste(italic("r"), " = 0.47, ",  , italic(p[spin]), "= 0.0001"))
...
ggsave(paste0(png_dir, "fig7_SA_bin5.png"), grid.arrange(arrangeGrob(agg_SA_parcel_plot_final, left = y.grob, bottom = x.grob)), height = 5, width = 15, units = "in")
```

```{r ttest for for parcel level SA map and maturation status}
...
perm.sphere.p.ttest(SAaxis = glasser_SAaxis$SA.axis_rank, perm.id = perm.id.full, dataset = "PNC", alternative = "greater", var.equal = FALSE) # t = 9.155703, pspin = 0, df = 313.48 
perm.sphere.p.ttest(SAaxis = glasser_SAaxis$SA.axis_rank, perm.id = perm.id.full, dataset = "HCPD", alternative = "greater", var.equal = FALSE) # t = 17.82604 , pspin = 0, df = 285.1
perm.sphere.p.ttest(SAaxis = glasser_SAaxis$SA.axis_rank, perm.id = perm.id.full, dataset = "HBN", alternative = "greater", var.equal = FALSE) # t = 0.1326557, pspin = N.S., df = 252.01


t.test(aggregated_axis_PNC_binary$SA.axis_rank[which(aggregated_axis_PNC_binary$maturation_status == 0)], 
                  aggregated_axis_PNC_binary$SA.axis_rank[which(aggregated_axis_PNC_binary$maturation_status == 1)], 
                  alternative = "greater", var.equal = FALSE) 

t.test(aggregated_axis_HCPD_binary$SA.axis_rank[which(aggregated_axis_HCPD_binary$maturation_status == 0)], 
                  aggregated_axis_HCPD_binary$SA.axis_rank[which(aggregated_axis_HCPD_binary$maturation_status == 1)], 
                  alternative = "greater", var.equal = FALSE) 

t.test(aggregated_axis_HBN_binary$SA.axis_rank[which(aggregated_axis_HBN_binary$maturation_status == 0)], 
                  aggregated_axis_HBN_binary$SA.axis_rank[which(aggregated_axis_HBN_binary$maturation_status == 1)], 
                  alternative = "greater", var.equal = FALSE) 
