...
dti_md_ageeffects_plots <- lapply(tracts, plot_age_effect_clipEnds, scalar = "dti_md", ageeffect_measure = ageeffect_measure, 
                                color1 = color1, color2 = color2, color3 = color3, clipEnds = 3, ylim2 = 0.5, ylim1 = 0)
...
ggsave(paste0(png_dir, "dti_md_ageeffect_association.png"), grid.arrange(arrangeGrob(dti_md_ageeffects_assoc_plots, left = y.grob)), height = 20, width = 16, units = "in")
```
