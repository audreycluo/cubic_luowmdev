...
def plot_tract_profile(tract_name, subject, study_path, tract_profiles_path, output_folder, view):
    ...
    csv_file = ospj(tract_profiles_path, f"{tract_name}_avg_tp.csv")
...
#Callosum bundles - plot for both coronal and axial view
...
for tract in tract_list:
    plot_tract_profile(tract, subject=subject, study_path=study_path, tract_profiles_path=tract_profiles_path, output_folder="/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/all_datasets/glass_brain/baseline", view = "axial")

for tract in tract_list:
    plot_tract_profile(tract, subject=subject, study_path=study_path, tract_profiles_path=tract_profiles_path, output_folder="/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/all_datasets/glass_brain/baseline", view = "coronal")



# Association bundles - plot for sagittal view
...
for tract in tract_list:
    plot_tract_profile(tract, subject=subject, study_path=study_path, tract_profiles_path=tract_profiles_path, output_folder="/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/all_datasets/glass_brain/baseline", view = "sagittal")
