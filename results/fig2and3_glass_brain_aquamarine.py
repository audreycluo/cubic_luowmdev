...
for tract in tract_list:
    plot_tract_profile(tract, subject=subject, study_path=study_path, tract_profiles_path=tract_profiles_path, output_folder="/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/all_datasets/glass_brain", view = "coronal", hex_colors = hex_colors)

for tract in tract_list:
    plot_tract_profile(tract, subject=subject, study_path=study_path, tract_profiles_path=tract_profiles_path, output_folder="/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/all_datasets/glass_brain", view = "axial", hex_colors = hex_colors)
...
for tract in tract_list:
    plot_tract_profile(tract, subject=subject, study_path=study_path, tract_profiles_path=tract_profiles_path, output_folder="/Users/audluo/PennLINC/luowm_local/output/tract_profiles_testing/all_datasets/glass_brain", view = "sagittal", hex_colors = hex_colors)
