...
# set variables
r_script="/cbica/projects/luo_wm_dev/code/tract_profiles/significance_testing/spin_tests/main_figures_spintests.R"
r_script_avg="/cbica/projects/luo_wm_dev/code/tract_profiles/significance_testing/spin_tests/main_figures_spintests_avgdatasets.R"
...
for dataset in "${datasets[@]}"; do
    ...
    job_name="main_figures_spintests_${dataset}"
...
job_name="main_figures_spintests_avgdatasets"
sbatch --job-name=main_figures_spintests_avgdatasets \
           --nodes=1 \
           --ntasks=1 \
           --cpus-per-task=1 \
           --mem-per-cpu=2G \
