...
saveRDS(tractwise_bam_no_re, "/cbica/projects/luo_wm_dev/output/HCPD/tract_profiles/GAM/dti_md/check_resid_tractwise_bam_no_re.RData")
...
- 8/2/24: things to check
    + look at summary of original model, especially the ti() term to see if it's significant (should be)
