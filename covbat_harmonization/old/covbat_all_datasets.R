...
merged_covbat_all <- final_dti_md_covbat %>% arrange(sub, tractID, nodeID, hemi) 

# save out!
saveRDS(merged_covbat_all, "/cbica/projects/luo_wm_dev/input/covbat_all_datasets/collated_tract_profiles_covbat_all_datasets_site.RData")
# saveRDS(merged_covbat_all, "/cbica/projects/luo_wm_dev/input/covbat_all_datasets/collated_tract_profiles_covbat_all_datasets.RData")
