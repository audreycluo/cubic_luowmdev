...
Output:
- collated_tract_profiles.tsv for each dataset for subjects with ALL tracts (rows = 100 nodes * 28 tracts * X subjects; columns = 4 metrics + tractID + nodeID).
    Note that this file will be changed in the final sample selection Rmd. Subjects missing non-essential tracts will be added back to collated_tract_profiles.tsv! 
- missing_tract_profiles_nocovbat.tsv for each dataset - tract profiles of all subjects missing at least 1 tract
