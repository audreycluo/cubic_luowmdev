...
test_map <- read.csv("/cbica/projects/luo_wm_dev/input/HCPD/derivatives/vol_to_surf/group/RightVerticalOccipital_0.1_glasser.csv")


ggplot() + 
      geom_brain(data = rh_maps$RightArcuate_0.1, atlas = glasser, 
