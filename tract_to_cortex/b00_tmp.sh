...
for dataset in "${datasets[@]}"; do
    ...
    sbatch --array=0-$((subject_count-1)) \
        --dependency=afterok:1617617 --job-name="b02_align_surfaces_with_tract_volumes_${dataset}" ./b02_align_surfaces_with_tract_volumes.sh ${subjects_file} ${config_file} ${logs_dir} "b02_align_surfaces_with_tract_volumes_${dataset}"
